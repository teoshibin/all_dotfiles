...
Import-Module -Name PSReadLine -ErrorAction SilentlyContinue          # display history
Import-Module -Name CompletionPredictor -ErrorAction SilentlyContinue # intelisense plugin
Import-Module -Name z -ErrorAction SilentlyContinue                   # z jump
...
function Enable-ChocoCompletion {
